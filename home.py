...
# --- HERO SECTION ---
with st.container():
    st.image("assets/iqs_header.png", width='stretch')
...
with st.container():
    ...
    with c1:
        st.markdown("### 🛠 UCT QCS Exclusive Workshop: Intro to QIS")
        st.markdown("""
        **Date:** Thursday, 30 April 2026 | **Time:** 17:30 – 19:00 | **Venue:** Online (MS Teams)
        
        Bridge the gap between math theory and actual Quantum Logic. Before we "get our hands dirty" with the code, join us for a session on translating theory into Bloch Spheres and Quantum Gates.
        
        **Why you need to be there:**
        - Translate math theory into Bloch Spheres and Quantum Gates.
        - Get the foundational "prerequisites" for the upcoming Build-A-Thon.
        - Meet the new Exec Team and see the project roadmap first-hand.
        """)
    with c2:
        st.markdown("<br>", unsafe_allow_html=True)
        st.link_button("Join via MS Teams", "https://teams.microsoft.com", width='stretch') # Placeholder link
...
with m_col1:
    st.image("assets/iqs_header.png", width='content')
